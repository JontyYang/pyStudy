...
if __name__ == "__main__":
    ...
    # 对模型进行训练
    optimizer = torch.optim.Adam(MyLeNet.parameters(), lr=0.0003)
    criterion = nn.CrossEntropyLoss()
    MyLeNet_params = torch.load("D:/SS/anacondaWork/pytorch/model/LeNet5_params.pkl")
    MyLeNet.load_state_dict(MyLeNet_params)
    MyLeNet5, train_process = train_model(MyLeNet, train_loader, 0.8, criterion, optimizer, num_epoch=2)
    ...
    torch.save(MyLeNet5.state_dict(), "D:/SS/anacondaWork/pytorch/model/LeNet5_params.pkl")
